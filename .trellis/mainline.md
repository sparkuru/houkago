...
| 7 | `.trellis/tasks/08-08-chromium-baidu-adaptor` | in progress | MV3 session-registry/DNR recovery is implemented; the 302-test automated gate, controlled installed-Chromium harness, Google Chrome full-reference matrix, and Microsoft Edge compatibility matrix pass. Final workflow handoff remains. |
